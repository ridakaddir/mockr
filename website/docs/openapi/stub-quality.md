...
[Home](/) > [OpenAPI](index) > Stub Quality
...
|---|---|
| `uuid` | <code v-pre>"{{uuid}}"</code> — rendered as a real UUID at request time |
| `date-time` | <code v-pre>"{{now}}"</code> — rendered as RFC 3339 timestamp at request time |
| `date` | `"2026-01-01"` |
