...
When using [directory config](README.md#directory-config), you can mix formats freely:
...
**See also:** [Configuration Overview](README.md) | [Routes](routes.md) | [Cases](cases.md)
